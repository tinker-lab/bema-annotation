...
namespace GhostscriptSharp
{
    ...
    public class GhostscriptWrapper
    {
            ...
            int height)
        {
            ...
            s.Resolution = new DrawingSize(dpix, dpiy);             // Replaced with my version because we couldn't get System.Drawing in
            ...
            else
            {
                ...
                pageSize.Manual = new DrawingSize(width, height);   // Replaced with my version because we couldn't get System.Drawing in
            }
            s.Size = pageSize;
    ...
    public class GhostscriptSettings
    {
        ...
        private DrawingSize _resolution;                                                    // Replaced with my version because we couldn't get System.Drawing in
        ...
        */
        ...
        public DrawingSize Resolution           // Replaced with my version because we couldn't get System.Drawing in
        {
            get { return this._resolution; }
            set { this._resolution = value; }
        }
...
namespace GhostscriptSharp.Settings
{
    ...
    public class GhostscriptPageSize
    {
        ...
        private DrawingSize _manual;            // Replaced with my version because we couldn't get System.Drawing in
        ...
        */
        public DrawingSize Manual                   // Replaced with my version because we couldn't get System.Drawing in
        {
            set
            {
                this._fixed = GhostscriptPageSizes.UNDEFINED;
        ...
        public GhostscriptPageSizes Native
        {
            set
            {
                ...
                this._manual = new DrawingSize(0, 0);
            }
            get
            {
                return this._fixed;
